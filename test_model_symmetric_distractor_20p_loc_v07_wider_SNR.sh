...
#SBATCH --output=outLogs/eval_binaural_word_task_20p_loc_v07_wider_SNR_%A_%a.out
#SBATCH --error=outLogs/eval_binaural_word_task_20p_loc_v07_wider_SNR_%A_%a.err
#SBATCH --mem=10Gb
#SBATCH --cpus-per-task=2
#SBATCH --time=0:15:00
#SBATCH --partition=use-everything
#SBATCH --gres=gpu:1 --constraint=20GB
#SBATCH --array=0-55 # 0-55 normally
