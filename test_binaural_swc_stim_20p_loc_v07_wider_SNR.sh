...
python3 eval_swc_mono_stim.py --config config/binaural_attn/word_task_20p_loc_v07_wider_SNR.yaml \
                 --ckpt_pat attn_cue_models/word_task_20p_loc_v07_wider_SNR/checkpoints/epoch=0-step=10000.ckpt \
                 --array_id $SLURM_ARRAY_TASK_ID \
                 --n_jobs 4 --exp_dir swc_mono_eval/ \
