...
python3 eval_diotic_w_manifest.py --config config/binaural_attn/word_task_half_co_loc_v08_gender_bal_4M_w_no_cue_learned_higher_lr_less_dropout.yaml \
                 ...
                 --test_manifest binaural_test_manifests/time_reversed_test_manifest_1_distractor.pkl \
                 --model_name word_task_half_co_loc_v08_gender_bal_4M_w_no_cue_learned_higher_lr_less_dropout --job_idx $SLURM_ARRAY_TASK_ID \
                 --gpus 1 --n_jobs 2 --exp_dir time_reversed_eval \
                 --cue_type voice_and_location --no-overwrite
