...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_sim_array_threshold_experiment_v02 --config config/arch_search/word_task_v10_4MGB_ln_first_arch_1.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_sim_array_threshold_experiment_v02 --config config/arch_search/word_task_v10_4MGB_ln_first_arch_2.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_sim_array_threshold_experiment_v02 --config config/arch_search/word_task_v10_4MGB_ln_first_arch_4.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_sim_array_threshold_experiment_v02 --config config/arch_search/word_task_v10_4MGB_ln_first_arch_6.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_sim_array_threshold_experiment_v02 --config config/arch_search/word_task_v10_4MGB_ln_first_arch_7.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_sim_array_threshold_experiment_v02 --config config/arch_search/word_task_v10_4MGB_ln_first_arch_8.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_sim_array_threshold_experiment_v02 --config config/arch_search/word_task_v10_4MGB_ln_first_arch_9.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_sim_array_threshold_experiment_v02 --config config/arch_search/word_task_v10_4MGB_ln_first_arch_10.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_sim_array_threshold_experiment_v02 --config config/arch_search/word_task_v10_4MGB_ln_first_arch_12.yaml \
