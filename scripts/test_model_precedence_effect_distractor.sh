...
python3 -m src.eval_precedence  --config config/binaural_attn/word_task_v10_main_feature_gain_config.yaml \
...
rm -rf /tmp/torchinductor_imgriff
python3 -m src.eval_precedence --config config/arch_search/word_task_v10_4MGB_ln_first_arch_1.yaml \
...
rm -rf /tmp/torchinductor_imgriff
python3 -m src.eval_precedence --config config/arch_search/word_task_v10_4MGB_ln_first_arch_2.yaml \
...
python3 -m src.eval_precedence --config config/arch_search/word_task_v10_4MGB_ln_first_arch_4.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_precedence --config config/arch_search/word_task_v10_4MGB_ln_first_arch_6.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_precedence --config config/arch_search/word_task_v10_4MGB_ln_first_arch_7.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 -m src.eval_precedence --config config/arch_search/word_task_v10_4MGB_ln_first_arch_8.yaml \
...
python3 -m src.eval_precedence --config config/arch_search/word_task_v10_4MGB_ln_first_arch_9.yaml \
...
python3 -m src.eval_precedence --config config/arch_search/word_task_v10_4MGB_ln_first_arch_10.yaml \
...
python3 -m src.eval_precedence --config config/arch_search/word_task_v10_4MGB_ln_first_arch_12.yaml \
