...
python3 -m src.get_acts_for_tuning_and_selection_analysis --config_list model_architecture_activation_manifests/all_v10_architectures_alts_and_controls.pkl \
                --n_activations 500 \
                --n_jobs 8 \
                --diotic \
