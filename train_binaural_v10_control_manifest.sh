...
which python3
python3 spatialtrain.py --config_list /om2/user/imgriff/projects/torch_2_aud_attn/binaural_train_manifests/v10_control_arch_manifest.pkl --job_id $SLURM_ARRAY_TASK_ID \
