...
python3 eval_swc_mono_stim.py --config config/binaural_attn/word_task_mono_arch_v05.yaml \
                 --ckpt_path attn_cue_models/word_task_mono_arch_v05/checkpoints/epoch=4-step=55232.ckpt \
                 --array_id $SLURM_ARRAY_TASK_ID \
                 --n_jobs 4 --exp_dir swc_mono_eval/ \
