...
python3 eval_sim_array_spotlight_experiment_v02.py --config config/binaural_attn/word_task_v10_backbone_word_config.yaml \
        ...
        --cue_type voice_and_location --no-overwrite --n_per_job 1 --run_all_stim --pink_noise_bg --backbone_with_ecdf_gains
