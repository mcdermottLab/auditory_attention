...
It contains a trained attention model, processed human-participant and model-simulation data, demo sounds, training and evaluation scripts, and evaluation notebooks needed to generate the figures and statistical tests in the manuscript. The sections below describe the layout, dependencies, and example use.
