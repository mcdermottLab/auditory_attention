...
then
  ...
  exp_dir="/om2/user/jcruse/projects/End-to-end-ASR-Pytorch/multi_talker_control/jsin_precombined_gammatone_40_channels_20kHz_on_gpu_1e-4lr"
fi

echo $main_file_name
echo $exp_dir

python3 compare_attn_tracking.py --config config/attentional_cue/${main_file_name} --gpus 1 --n_jobs 20 --exp_dir $exp_dir
