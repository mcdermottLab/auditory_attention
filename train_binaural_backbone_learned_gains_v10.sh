...
#SBATCH --output=outLogs/train_gains_on_backbone_v10_main_feature_gain_arch_%j.out
#SBATCH --error=outLogs/train_gains_on_backbone_v10_main_feature_gain_arch_%j.err # train_v09_gender_bal_4M_w_no_cue_learned_ word_task_v09_cue_loc_task_
#SBATCH --mem=100Gb
#SBATCH -N 1
