...
#SBATCH --output=outLogs/word_task_conventional_layer_order_%j.out
#SBATCH --error=outLogs/word_task_conventional_layer_order_%j.err # train_v08_gender_bal_4M_orig_ learned_avg
#SBATCH --mem=100GB
#SBATCH -N 1
