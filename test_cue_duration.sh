...
python3 eval_cue_duration_mono.py --config /om2/user/imgriff/projects/torch_2_aud_attn/config/binaural_attn/word_task_v10_main_feature_gain_config.yaml \
                 --ckpt_path attn_cue_models/word_task_v10_main_feature_gain_config/checkpoints/epoch=1-step=24679-v1.ckpt \
                 --test_manifest_path /om2/user/imgriff/projects/torch_2_aud_attn/binaural_test_manifests/cue_duration_test_manifest_1talker_only_0dB_snr.pkl \
                 --array_id $SLURM_ARRAY_TASK_ID \
                 --n_jobs 4 --exp_dir cue_duration_eval_center_crop_v1/ \
