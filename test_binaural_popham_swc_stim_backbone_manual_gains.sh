...
#SBATCH --array=0,3,5,7,10,11 # 0-11 for all combos;  0,3,5,7,10,11 for conditions in paper 
...
python3 eval_swc_popham_2024.py --config config/binaural_attn/word_task_v10_backbone_word_config.yaml \
