...
#SBATCH --array=0-14 #0-15 for all azimuth conditions 
...
python3 eval_sim_array_spotlight_experiment_v02.py --config config/binaural_attn/word_task_v10_main_feature_gain_config.yaml \
                 ...
                 --gpus 1 --n_jobs 2 --exp_dir binaural_eval/sim_azim_spotlight_v02 \
                 --cue_type voice_and_location --no-overwrite --n_per_job 1 --run_all_stim 
