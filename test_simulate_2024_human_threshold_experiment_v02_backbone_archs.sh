...
python3 eval_sim_array_threshold_experiment_v02.py --config config/binaural_attn/word_task_v10_backbone_word_config.yaml \
        ...
        --cue_type voice_and_location --no-overwrite --n_per_job 1 --sim_human_array_exmpt --run_all_stim --pink_noise_distractor  --backbone_with_ecdf_gains
