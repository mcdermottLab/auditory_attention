...
python3 eval_swc_popham_2024.py --config config/binaural_attn/word_task_late_only_v09.yaml \
...
# python3 eval_swc_popham_2024.py --config config/binaural_attn/word_task_v09_control_no_attn.yaml \
