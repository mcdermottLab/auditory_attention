...
def get_activations(args):
    ...
    dataset = SWCHumanExperimentStimDataset(path='/orcd/data/jhm/001/om/imgriff/datasets/human_word_rec_SWC_2024/full_cue_target_distractor_df_w_meta.pdpkl',
                                            run_all_stim=True,
                                            sr=44_100)
...
def cli_main():
    ...
    parser.add_argument("--room_manifest_path", 
                        default="/orcd/data/jhm/001/om2/msaddler/spatial_audio_pipeline/assets/brir/eval",
                        type=str,
