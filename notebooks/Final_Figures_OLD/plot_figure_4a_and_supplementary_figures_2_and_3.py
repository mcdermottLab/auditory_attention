...
ax.invert_yaxis()
ax.set_aspect('equal')
plt.savefig(fig_out_dir / "figure_4a_model_azim_summary.pdf", transparent=True, bbox_inches='tight')
...
ax.invert_yaxis()
ax.set_aspect('equal')
plt.savefig(fig_out_dir / "figure_4a_model_elevation_summary.pdf", transparent=True, bbox_inches='tight')
...
plt.savefig(fig_out_dir / "sup_fig_2_azim_x_azim_per_elevation.pdf", transparent=True, bbox_inches='tight')
...
plt.tight_layout(rect=[0, 0, 0.9, 1])  # Adjust layout to make room for colorbars
plt.savefig(fig_out_dir / "sup_fig_3_elev_x_elev_per_azim.pdf", transparent=True, bbox_inches='tight')
