...
plt.savefig(fig_out_dir / "sup_figure_4a_speech_v_ssn_distractor_azim-x-azim.pdf", transparent=True, bbox_inches='tight')
...
plt.savefig(fig_out_dir / "sup_figure_4b_azim-x-azim_lineplot.pdf", transparent=True, bbox_inches='tight')
