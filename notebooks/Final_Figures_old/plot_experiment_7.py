...
g.savefig(fig_out_dir / "figure_4e_experiment_7.pdf", transparent=True, bbox_inches='tight')
...
print("Experiment 7: ANOVA for humans")
...
g.savefig(fig_out_dir / "figure_4f_experiment_7_practice_effect.pdf", transparent=True, bbox_inches='tight')
