...
#SBATCH --output=outLogs/binaural_swc_test_2024_saddler_backbone_%A_%a.out
#SBATCH --error=outLogs/binaural_swc_test_2024_saddler_backbone_%A_%a.err
#SBATCH --mem=12Gb
#SBATCH --cpus-per-task=4
#SBATCH --time=0:30:00
#SBATCH --partition=normal
#SBATCH --gres=gpu:1 --constraint=20GB
#SBATCH --array=0-60 #-60 # -60 # 0-60 for standard test
