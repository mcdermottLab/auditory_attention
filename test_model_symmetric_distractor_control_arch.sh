...
#SBATCH --output=outLogs/eval_symmetric_confs_word_task_v08_control_no_attn_%A_%a.out
#SBATCH --error=outLogs/eval_symmetric_confs_word_task_v08_control_no_attn_%A_%a.err
#SBATCH --mem=10Gb
...
python3 eval_symmetric_distractors.py --config config/binaural_attn/word_task_v08_control_no_attn.yaml \
                 ...
                 --model_name word_task_v08_control_no_attn --location_idx $SLURM_ARRAY_TASK_ID \
