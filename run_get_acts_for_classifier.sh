...
#SBATCH --output=outLogs/get_unit_acts_for_classifier%j.out
#SBATCH --error=outLogs/get_unit_acts_for_classifier%j.err
#SBATCH --mem=8Gb                           
...
python3 get_acts_for_offline_classifier.py --config config/binaural_attn/word_task_v10_main_feature_gain_config.yaml \
                --ckpt_path attn_cue_models/word_task_v10_main_feature_gain_config/checkpoints/epoch=1-step=24679-v1.ckpt \
                --n_activations 976 \
                --model_dir acts_for_classifier \
