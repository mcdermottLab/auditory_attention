...
#SBATCH --output=outLogs/eval_binaural_word_task_quarter_co_loc_v08_%A_%a.out
#SBATCH --error=outLogs/eval_binaural_word_task_quarter_co_loc_v08_%A_%a.err
#SBATCH --mem=10Gb
...
which python3
python3 eval_binaural_w_manifest.py --config /om2/user/imgriff/projects/torch_2_aud_attn/config/binaural_attn/word_task_quarter_co_loc_v08.yaml \
