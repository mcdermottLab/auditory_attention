...
#SBATCH --array=2,4,6,11-15 #0-15 for all azimuth conditions 
...
rm -r /tmp/torchinductor_imgriff
python3 eval_sim_array_spotlight_experiment_v02.py --config config/arch_search/word_task_v10_4MGB_ln_first_arch_1.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 eval_sim_array_spotlight_experiment_v02.py --config config/arch_search/word_task_v10_4MGB_ln_first_arch_2.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 eval_sim_array_spotlight_experiment_v02.py --config config/arch_search/word_task_v10_4MGB_ln_first_arch_4.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 eval_sim_array_spotlight_experiment_v02.py --config config/arch_search/word_task_v10_4MGB_ln_first_arch_6.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 eval_sim_array_spotlight_experiment_v02.py --config config/arch_search/word_task_v10_4MGB_ln_first_arch_7.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 eval_sim_array_spotlight_experiment_v02.py --config config/arch_search/word_task_v10_4MGB_ln_first_arch_8.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 eval_sim_array_spotlight_experiment_v02.py --config config/arch_search/word_task_v10_4MGB_ln_first_arch_9.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 eval_sim_array_spotlight_experiment_v02.py --config config/arch_search/word_task_v10_4MGB_ln_first_arch_10.yaml \
...
rm -r /tmp/torchinductor_imgriff
python3 eval_sim_array_spotlight_experiment_v02.py --config config/arch_search/word_task_v10_4MGB_ln_first_arch_12.yaml \
