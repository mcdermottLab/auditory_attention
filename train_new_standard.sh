...
#SBATCH --output=outLogs/word_task_new_standard_%j.out
#SBATCH --error=outLogs/word_task_new_standard_%j.err # train_v08_gender_bal_4M_orig_ learned_avg
#SBATCH --mem=100GB
#SBATCH -N 1
...
python3 spatialtrain.py --config config/binaural_attn/word_task_new_standard.yaml \
                 --gpus 4 --n_jobs 16 --resume_training True \
                 --exp_dir attn_cue_models \
