...
def cnn_rnnt_model(
    *,
    ...
    r"""Builds CNN-based recurrent neural network transducer (RNN-T) model.
    ...
    Args:
        ...
        encoding_dim (int): dimension of transcription- and prediction-network-generated encodings
            passed to joint network.
        num_symbols (int): cardinality of set of target tokens.
        encoder (dict): dict of parameters for transcriber .
        decoder (dict): dict of parameters for predictor.
