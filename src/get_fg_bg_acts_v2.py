...
def get_activations(args):
    ...
    # set up h5 file for activations
    ...
    # refactor above to save activations for each layer as a group in an hdf5 file
    # with h5py.File(out_name, 'w') as f:
    #     for layer in mixture_reps.keys():
    #         f.create_dataset(layer, data=mixture_reps[layer])
