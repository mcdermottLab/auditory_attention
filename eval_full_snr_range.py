...
eval_cond_path = '/om2/user/jcruse/projects/End-to-end-ASR-Pytorch/attn_cnn_snr_eval_conditions.pkl'
...
def run_eval(args):
    ...
    if snr == 'clean':
        ...
        log_name = f"{model_name}_{snr}dB_SNR"
...
#     test_condition = eval_conditions[args.array_id]
    ...
    elif model_name == 'AttnCNN' or model_name == "AttnCNNPosSlope" or model_name == "AttnCNNConstrained":
