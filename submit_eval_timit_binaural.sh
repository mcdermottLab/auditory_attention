...
python3 eval_timit.py --gpus 1 --n_jobs 5 --exp_dir "attn_cue_models/attn_timit_task" \
                      --model_name "BinauralCueWReportW_v2" \
                      --config_name config/binaural_attn/word_task_voice_cue.yml \
                      --ckpt_path attn_cue_models/word_task_voice_cue/checkpoints/epoch=0-step=750.ckpt
