...
#SBATCH --output=outLogs/train_deep_binaural_attn_%j.out
#SBATCH --error=outLogs/train_deep_binaural_attn_%j.err
#SBATCH --mem=100Gb
#SBATCH -N 1
...
which python3
python3 spatialtrain.py --config config/binaural_attn/word_task_deep_fc_1024_v08.yaml  \
