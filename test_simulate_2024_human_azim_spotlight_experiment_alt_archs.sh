...
python3 eval_symmetric_distractors.py --config config/binaural_attn/word_task_half_co_loc_v09_gender_bal_4M_w_no_cue_learned_higher_lr_less_dropout.yaml \
                 ...
                 --gpus 1 --n_jobs 2 --exp_dir binaural_eval/simulate_2024_human_azimuth_spotlight_experiment_v02 \
                 --cue_type voice_and_location --no-overwrite --n_per_job 1 --sim_human_array_exmpt --run_all_stim 


rm -r /tmp/torchinductor_imgriff

python3 eval_symmetric_distractors.py --config config/arch_search/word_task_v09_4MGB_ln_first_arch_1.yaml \
...
python3 eval_symmetric_distractors.py --config config/arch_search/word_task_v09_4MGB_ln_first_arch_2.yaml \
...
python3 eval_symmetric_distractors.py --config config/arch_search/word_task_v09_4MGB_ln_first_arch_4.yaml \
...
python3 eval_symmetric_distractors.py --config config/arch_search/word_task_v09_4MGB_ln_first_arch_6.yaml \
...
python3 eval_symmetric_distractors.py --config config/arch_search/word_task_v09_4MGB_ln_first_arch_7.yaml \
...
python3 eval_symmetric_distractors.py --config config/arch_search/word_task_v09_4MGB_ln_first_arch_8.yaml \
...
python3 eval_symmetric_distractors.py --config config/arch_search/word_task_v09_4MGB_ln_first_arch_9.yaml \
